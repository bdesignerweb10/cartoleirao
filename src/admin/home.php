		...
		<div class="row">
			<div class="col-sm-3">
				<div class="card spacing text-white bg-success mb-3" style="max-width: 18rem;">
				  <div class="card-header">Temporada 2019</div>
				  <div class="card-body">
				  	<p class="card-text"><span>Status da temporada</span></p>
				    <h5 class="card-title">Temp. Aberta</h5>				    
				  </div>
				</div>
			</div><!-- col-sm-3-->
			<div class="col-sm-3">
				<div class="card spacing text-white bg-danger mb-3" style="max-width: 18rem;">
				  <div class="card-header">1º Rodada</div>
				  <div class="card-body">
				  	<p class="card-text"><span>Status do mercado</span></p>
				    <h5 class="card-title">Merc. Fechado</h5>				    
				  </div>
				</div>
			</div><!-- col-sm-3-->
			<div class="col-sm-3">
